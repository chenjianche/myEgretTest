...
(function (fighter) {
    ...
    var GameContainer = (function (_super) {
        ...
        function GameContainer() {
            ...
            /**我的成绩*/
            _this.myScore = 0;
            _this.myBloodBarWidth = 150;
            /**myBuff */
            _this.myBuffs = [];
            /**myPower */
            _this.myPowerLevel = 0;
        ...
        GameContainer.prototype.createGameScene = function () {
            ...
            //创建血条
            var hpImg = fighter.createBitmapByName("hp_png");
            hpImg.x = 10;
            hpImg.y = 10;
            this.addChild(hpImg);
            var bloodBarBg = fighter.createBitmapByName("bloodBarBg_png");
            bloodBarBg.x = 80;
            bloodBarBg.y = 15;
        ...
        GameContainer.prototype.preCreatedInstance = function () {
            ...
            for (i = 0; i < 20; i++) {
                var buff = fighter.Buff.produce("buff_blood", fighter.BuffTypes.BloodAdd);
                objArr.push(buff);
            }
            for (i = 0; i < 20; i++) {
                buff = objArr.pop();
        ...
        /**创建buff */
        GameContainer.prototype.createBuff = function (x, y) {
            ...
            var textureName;
            if (rr >= 95) {
                buffType = fighter.BuffTypes.BloodAdd;
                textureName = "buff_blood";
            }
            else if (rr <= 5) {
                buffType = fighter.BuffTypes.PowerUp;
                textureName = "buff_power";
            }
            else {
                return;
            }
            var buff = fighter.Buff.produce(textureName, buffType);
            buff.x = x;
            buff.y = y;
        ...
        /**设置我的血条 */
        GameContainer.prototype.setMyBloodBar = function (blood) {
            if (blood <= 10) {
        ...
        GameContainer.prototype.gameHitTest = function () {
            ...
            for (i = 0; i < buffCount; i++) {
                ...
                if (fighter.GameUtil.hitTest(this.myFighter, buff)) {
                    if (buff.BuffType == fighter.BuffTypes.BloodAdd) {
